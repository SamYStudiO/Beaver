...
Android Project template using View [MVVM](https://developer.android.com/topic/libraries/architecture/index.html) Repository Data pattern, with [Dagger 2](https://github.com/google/dagger) and [Jetpack (Androidx)](https://developer.android.com/jetpack/) libraries.
