...
based on milliseconds time though becauseof 2147483647 (Int max) version code limitation.
Here we make a build number that increment only every minute so we should never reach 2147483647.
*/
