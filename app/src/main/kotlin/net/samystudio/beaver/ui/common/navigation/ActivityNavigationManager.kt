...
constructor(protected val activity: AppCompatActivity) :
    ...
    fun startActivity(
        ...
        startActivity(
            ActivityRequest(
                activityClass, extras, options, forResultRequestCode,
    ...
    fun startActivity(activityRequest: ActivityRequest): ActivityRequest {
        ...
        if (activityRequest.forResultRequestCode != null)
            activity.startActivityForResult(
                intent, activityRequest.forResultRequestCode,
    ...
    private constructor(
        private val activityClass: Class<out BaseActivity<*>>? = null,
        ...
        constructor(
            activityClass: Class<out BaseActivity<*>>, extras: Bundle? = null,
            options: Bundle? = null, forResultRequestCode: Int? = null,
            finishCurrentActivity: Boolean = false
        ) :
                this(
                    activityClass, null, extras, options, forResultRequestCode,
                    finishCurrentActivity
                )

        constructor(
            intent: Intent, options: Bundle? = null, forResultRequestCode: Int? = null,
            finishCurrentActivity: Boolean = false
        ) :
